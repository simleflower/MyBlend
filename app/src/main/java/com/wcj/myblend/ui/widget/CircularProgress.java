package com.wcj.myblend.ui.widget;
...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setColorSchemeResource(mColors[mCurrentColorIndex]);
        setupAnimations();
    }

    public void setColorSchemeResource(int colorResId){
        int colorRes = ContextCompat.getColor(context, colorResId);
    ...
    public void draw(Canvas canvas) {
        ...
        if (mModeAppearing) {
            mPaint.setColor(
                    gradient(
                            ContextCompat.getColor(context, mColors[mCurrentColorIndex]),
                            ContextCompat.getColor(context, mColors[mNextColorIndex]),
