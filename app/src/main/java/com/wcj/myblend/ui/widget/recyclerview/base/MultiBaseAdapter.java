...
import com.wcj.myblend.ui.widget.recyclerview.interfaces.OnMultiItemClickListeners;
...
public abstract class MultiBaseAdapter<T> extends BaseAdapter<T> {
    ...
    protected abstract void convert(ViewHolder holder, Collection data, int viewType);
